...
SECRET_KEY = 'django-insecure-1-z2@!*j3r!ci4_)8=kc0a1(8so!ipwdcz=q@swots2b%)$f9%'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'nanoride_latest',  # Replace with your database name
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Global static files folder
]

# Media files (for file uploads, like profile pictures)
MEDIA_URL = '/media/'
